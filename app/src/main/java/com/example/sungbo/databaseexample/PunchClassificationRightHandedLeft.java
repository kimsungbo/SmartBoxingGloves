...
public class PunchClassificationRightHandedLeft {
    ...
    public PunchClassificationRightHandedLeft(Context mContext, double feature_x, double feature_y, double feature_z){
    ...
    public boolean loadModel(){
        ...
        try {
            mClassifier = (Classifier) weka.core.SerializationHelper.read(assetManager.open("righthanded-left.model"));
